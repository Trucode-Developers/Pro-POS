              ...
              <div key={item.id} className="flex flex-col">
                ...
                {item.children.map((sub) => (
                  <Link
                    href={sub.link}
                    key={sub.id}
                    className="flex flex-col py-[4px]"
                  >
                    <div className="flex items-center gap-2 hover:text-secondary group">
                      <Image
                        src={sub.image}
                        width={50}
                        height={50}
                      ...
                      <div>
                        <div>{sub.title}</div>
                        <div className="group-hover:block hidden duration-500 ease-in-out">
                          {sub.description}
                        </div>
                      </div>
                    </div>
